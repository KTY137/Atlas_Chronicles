...
`design/iterations/stadt-zukunft-20260923.md`. In `main` (Merge von `feature/stadt-zukunft`).
...
SHA-256 `44C018B0…DE27C8`. **Veröffentlicht** als GitHub-Release `v0.4.2`. **Offen:** Teil 2 Heimnetz, Teil 3 Internet.

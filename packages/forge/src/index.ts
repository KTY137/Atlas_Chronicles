...
export { SIEDLUNG_ERZEUGER, SIEDLUNG_VERSION, SIEDLUNG_VIERTEL_VERSION, SIEDLUNG_LIMITS, SIEDLUNG_STANDARD, SIEDLUNG_STANDORTE, siedlungStandard, erzeugeSiedlung } from "./siedlung.ts";

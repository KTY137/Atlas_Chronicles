...
const FILES = ["RuleForge.tsx", "RuleActionEditor.tsx", "RuleFieldList.tsx", "RuleDeclarativeEditor.tsx", "RuleForgePreview.tsx", "FormulaField.tsx", "FormulaLine.tsx", "FormulaBlocks.tsx", "FormulaGraph.tsx", "formula-sugar.ts", "formula-example.ts", "formula-graph-model.ts", "RuleMap.tsx", "rule-map-model.ts", "RuleForgePath.tsx", "RulePresentationEditor.tsx", "RulePresentationView.tsx", "HostRuleFields.tsx", "RuleAbilityEditor.tsx", "rule-ability-model.ts", "RuleEntryControls.tsx", "rule-ability-references.ts", "RuleForgeNav.tsx", "RuleVitalEditor.tsx", "RuleCollectionEditor.tsx", "RuleEntryList.tsx", "rule-sheet-model.ts", "rule-vital-model.ts", "ChronicleHeroesTemplate.tsx", "Vitalanzeige.tsx", "RuleWizard.tsx", "rule-wizard-model.ts", "rule-draft-history.ts", "rule-draft-store.ts", "forge-navigation-model.ts", "RuleComputedFields.tsx", "HostRuleActionFields.tsx"];

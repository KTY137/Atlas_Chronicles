...
const textDateien: (() => Promise<Record<string, unknown>>)[] = [
  ...
  () => import("./i18n/en/zugang-basis.json"),
  () => import("./i18n/en/zugang-bogen.json"),
  () => import("./i18n/en/zugang-schmiede.json"),
  () => import("./i18n/en/zugang-figuren.json"),
  ...
  () => import("./i18n/en/P13.json"), () => import("./i18n/en/P14.json"), () => import("./i18n/en/P15.json"), () => import("./i18n/en/P16.json"), () => import("./i18n/en/P17.json"), () => import("./i18n/en/P18.json"),
];

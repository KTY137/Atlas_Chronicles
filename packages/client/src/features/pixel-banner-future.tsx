...
import { Clouds, Fireflies, Moon, Rain, Sky, type Palette } from "./pixel-banner-primitives";
...
function NeonRain() {
  ...
  return <><Sky p={p} /><Moon p={p} x={357} y={5} /><Skyline p={p} />
    ...
    <path fill="#d6b2c0" d="M237 79v-6h2v2h4v-2h2v9h-8zM245 79h3v-4h2v6h-5z" /><path fill="#131f33" d="M239 77h1v1h-1zM243 77h1v1h-1z" />
    ...
    <path fill="none" stroke="#11182c" d="M180 8q150 31 280-3M55 10q150 32 227 3" /><Rain p={p} />
  </>;
}
...
function RoofGardens() {
  ...
  return <><Sky p={p} stars={false} /><Moon p={p} x={360} y={3} sun /><Clouds p={p} /><Skyline p={p} green />
    ...
    <g transform="translate(263 57)"><path fill="#eed7a2" d="M-4-7h8v3h-8zM-2-10h4v3h-4zM-2-4h4v4h-4z" /><path fill="#417b7a" d="M-3 0h6v6h-6zM3 1h4v2H3z" /><path fill="#263f38" d="M-3 6h2v3h-2zM1 6h2v3H1z" /><path fill="#a7c7b1" d="M6 1h5v5H6zM11 2h3v2h-3z" /><path className="pb-drip" fill="#dfedc5" d="M15 4h1v2h-1zM16 7h1v2h-1z" /></g>
...
function BioLab() {
  ...
  return <><Sky p={p} stars={false} />
    ...
    <g transform="translate(316 45)"><g className="pb-float"><path fill="#335d49" d="M-11-8h5v-4h13v4h5v10H8v7H3v4H0V9h-4v4h-3V7h-4z" /><path fill="#c0e697" d="M-9-8h4v-2H6v2h4v8H6v5H-5V0h-4z" /><path fill="#315447" d="M-6-6h4v5h-4zM4-6h4v5H4z" /><path fill="#e9ffc4" d="M-5-6h1v2h-1zM5-6h1v2H5z" /><path fill="#74b479" d="M-1 1h3v2h-3zM-4 5h3v4h-3zM3 5h3v4H3z" /><path fill="#d7efa7" d="M-12 1h3v2h-3zM10 1h3v2h-3z" /></g></g>
    <g className="pb-bubbles" fill="none" stroke="#d3f6b4" opacity=".75"><path d="M289 52h3v3h-3zM337 36h2v2h-2zM331 54h3v3h-3zM298 36h2v2h-2z" /></g>
    <path fill="#19372f" d="M230 54h38v25h-38zM363 51h42v27h-42z" /><path fill="#74967a" d="M228 53h42v3h-42zM361 50h47v3h-47z" />
    <path fill="#8ec590" d="M237 35h21v14h-21z" /><path fill="#264a3e" d="M240 38h15v8h-15z" /><path className="pb-lantern" fill="#d1eeb0" d="M242 40h5v2h-5zM242 43h10v1h-10z" />
...
function DataStream() {
  ...
  return <><Sky p={p} />
    ...
    <g transform="translate(319 34)"><g className="pb-float">
...
function DeepStation() {
  ...
  return <><Sky p={p} stars={false} />
    ...
    <g transform="translate(347 22)"><g className="pb-float"><path fill="#316274" d="M-40-7h15v-4h40v4h16v5h10v7h-9v5H17v4H-6v-4h-17V6h-15V2h-7V-4h5zM-44-2h-8v-7h-7v6h3v5h12zM-1 11h12v10H6v-3H1z" /><path fill="#4e8190" d="M-29-8h43v3h15v3h-55v-2h-9v-2h6z" /><path fill="#7ba0a4" d="M-14 7h43v2H17v3H-6V9h-8z" /><path fill="#c5e7ce" d="M27 0h2v2h-2z" /><path fill="#163f54" d="M28 6h10v1H28z" /></g></g>
...
function SolarGrid() {
  ...
  return <><Sky p={p} />
    ...
    <path fill="#987aaa" d="M308 73h21v1h-21zM340 79h2v2h-2zM296 79h2v2h-2zM302 87h8v1h-8zM329 87h8v1h-8z" />
...
function PastelPalms() {
  ...
  return <><Sky p={p} stars={false} /><Moon p={p} x={297} y={6} sun /><Clouds p={p} />
    ...
    <g transform="translate(307 77)"><g className="pb-float"><path fill="#f3a4b7" d="M-8-2h12v2h4v3H4v2H-8V3h-3V0h3zM4-2v-8h2v-4h6v2H8v2H7v8z" /><path fill="#ffe0d4" d="M-6-1h8v1h-8zM8-13h3v1H8z" /><path fill="#75567b" d="M10-11h4v2h-4zM9-13h1v1H9zM-4 1h5v1h-5z" /></g></g>
...
function RocketPort() {
  ...
  return <><Sky p={p} /><Clouds p={p} />
    ...
    <path fill="#f6af76" className="pb-exhaust" d="M312 61h12v6h-2v8h-3v5h-3v-5h-2v-8h-2z" /><path fill="#ffdf9e" className="pb-twinkle" d="M315 61h6v8h-2v4h-2v-4h-2z" />
...
function OrbitalRing() {
  ...
  return <><Sky p={p} />
    ...
    <g transform="translate(390 43)"><g className="pb-float"><path fill="#7385a1" d="M-9-3h16v8H-9zM-28-10h14v20h-14zM14-10h15v20H14z" /><path fill="#a1bfd1" d="M-8-2H6v2H-8zM-25-8h8v1h-8zM17-8h9v1h-9z" /><path fill="#35486c" d="M-26-6h10v14h-10zM16-6h11v14H16z" /><path fill="#7785b1" d="M-22-6h1V8h-1zM-26 0h10v1h-10zM21-6h1V8h-1zM16 0h11v1H16z" /><path fill="#d6d6d0" d="M-3-6h5v3h-5zM-1-10h1v4h-1z" /><path fill="#9fe0dc" className="pb-beacon" d="M3 1h2v2H3z" /></g></g>
    <path fill="none" stroke="#aeb2c8" opacity=".8" d="M266 57q-26 29-42 6" />
    <g transform="translate(222 59)"><g className="pb-float"><path fill="#c8c9d4" d="M-3-7h7v7h-7zM-5 0H5v9H-5zM-8 1h3v5h-3zM5 0h4v3H5zM-5 9h3v5h-3zM2 9h3v4H2z" /><path fill="#35516b" d="M-1-5h5v3h-5zM-2 3h4v3h-4z" /><path fill="#e4dacc" d="M-3-7h6v1h-6z" /></g></g>
...
function GhostTown() {
  ...
  return <><Sky p={p} /><Moon p={p} x={286} y={3} /><Clouds p={p} />
    ...
    <g transform="translate(318 78)"><path fill="#283044" d="M-17-16h32v5h4v17h-40v-17h4z" /><path fill="#6b7680" d="M-17-11h32V3h-32z" /><path fill="#a7bbb2" d="M-14-9h8v8h-8zM-3-9h8v8h-8zM8-9h5v8H8z" /><path fill="#404552" d="M-17-1h32v2h-32zM-16 6h6v4h-6zM8 6h6v4H8z" /><path fill="#cfc9a9" d="M-16 2h4v2h-4zM10 2h4v2h-4z" /><path fill="#797080" d="M-9-17h17v-2H1v-9h2v8h8v3z" /><path fill="#26394a" d="M-11-8h2v4h-2zM0-8h2v4H0z" /></g>
    <g transform="translate(244 65)"><g className="pb-float"><path fill="#c5dbd3" opacity=".8" d="M-4-7h7v2h3V8H3V5H1v3h-2V5h-2v3h-3V-5h2z" /><path fill="#536174" d="M-2-3h2v3h-2zM2-3h2v3H2z" /><path fill="#e0e6d7" d="M-2-6h4v1h-4z" /></g></g>
    ...
    <path fill="#aca897" d="M304 65h10v1h-10zM321 65h10v1h-10zM300 81h2v1h-2zM333 81h2v1h-2z" />
